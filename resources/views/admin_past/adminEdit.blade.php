...
<x-app-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-">
        ...
        <div class="w-full flex-col sm:max-w-md mt-6 px-6 py-4 bg-gray-900 shadow-md overflow-hidden sm:rounded-lg">
...
<div class="mt-4">
    ...
    <input type="date" id="data_nascimento" placeholder="John Doe" name="data_nascimento" value="{{ $user->data_nascimento }}" required autocomplete="username" class="block mt-1 w-full" />
